...
const useMeasure = (): [MutableRefObject<HTMLDivElement | null>, { width: number; height: number }] => {
...
const Masonry = ({
  ...
  // Calculate total height for the container so it doesn't collapse
            ...
            {colorShiftOnHover && (
              <div
                ...
                style={{
                  ...
                  height: '100%',
                  background:
                    'linear-gradient(45deg, rgba(109,80,163,0.5), rgba(99,194,224,0.5))',
                  opacity: 0,
                  pointerEvents: 'none',
                  borderRadius: '12px',
                }}
